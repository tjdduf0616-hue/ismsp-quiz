...
const ids = new Set();
const byCat = {};
const VALID_CATS = ['고난도','암기','AI','가명','직책','제도','관리','보호','개인정보','개인정보기준','기준종합','법령','안전성','클라우드','보안기술','보안기사','신기술','결함사례','주요확인','시스템보안','CPPG1','CPPG2','CPPG3','CPPG4','CPPG5','ISRM1','ISRM2','ISRM3','ISRM4','ISRM5'];
